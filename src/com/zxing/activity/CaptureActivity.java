...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(CaptureActivity.this, "스캔실패!", Toast.LENGTH_SHORT)
					.show();
		} else {
		...
		if (resultCode == RESULT_OK) {
			...
			case 1:
				...
				if (resultString == null){
					Toast.makeText(getApplicationContext(), "qr코드를 찾을수 없습니다！", Toast.LENGTH_LONG).show();
				}else{
					String resultImage = resultString.getText();
					if (resultImage.equals("")) {
						Toast.makeText(CaptureActivity.this, "스캔실패!",
	...
	private Result scanningImage1(String picturePath) {
		...
		try {
			...
			Toast.makeText(CaptureActivity.this, "qr코드를 찾을수 없습니다！",
					Toast.LENGTH_LONG).show();
			e.printStackTrace();
